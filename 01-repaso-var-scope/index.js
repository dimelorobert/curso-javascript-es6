...
/*
   ...
   NOTA:
   'Var' contamina el ambiente global, la unica forma de evitar esto es envolverlo en una funcion.
*/
...
/*
   Un problema muy comun es que al estar viviendo en el contexto del global object,
...
/*
   ...
   cada registro con una funcion que regrese el numero.
   El primer metodo seria el mas comun, pero vemos que nos imprime 10 veces 10.
   ...
   Para limitar el scope de 'var', se recurre a contenerlo dentro de una funcion, el metodo 2,
   ...
   Esto porque toda variable 'var' declarada fuera de una funcion, se aloja en el global object, en este caso window,
...
/*
   ...
   - 'var' puede ser limitada en su alcance(scope), envolviendola en una funcion
 ...
 * Con 'let'  crea una nueva instancia de 'i', en cada iteracion, 
 * por eso no se comparte esa referencia como lo hace 'var'.
 * Por consiguiente nos ahorramos varias lineas de codigo
